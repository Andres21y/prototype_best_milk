const Dashboard = {
    render() {
      ...
      <div class="row">
                <div class="col s6 m3">
                    <div class="dash_card">
                        <div class="dash_card_content">
                         <div class="row dash_card_stat">
                            <i class="material-icons small">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="40pt" height="20pt"
                    viewBox="0 0 1280.000000 969.000000" preserveAspectRatio="xMidYMid meet">
                    <metadata>
                        Created by potrace 1.15, written by Peter Selinger 2001-2017
                    </metadata>
                    <g transform="translate(0.000000,969.000000) scale(0.100000,-0.100000)" fill="#36c000ff"
                        stroke="none">
                        <path
                ...
                <div class="col s6 m3">
                    <div class="dash_card">
                        <div class="dash_card_content">
                            <div class="row dash_card_stat">
                            <i class="material-icons small blue-text lighten-4">local_drink</i>
                            <h6>Litros Hoy</h6>
                            </div>
                            <span>2,340</span>
                        </div>
                ...
                <div class="col s6 m3">
                       <div class="dash_card">
                        <div class="dash_card_content">
                        <div class="row dash_card_stat">
                            <i class="material-icons small brown-text darken-2">people</i>
                            <h6>Personal</h6>
                            </div>
                            <span>12</span>
                        </div>
                ...
                <div class="col s6 m3">
                        ...
                        <div class="dash_card_content">
                        <div class="row dash_card_stat">
                            <i class="material-icons small deep-orange-text accent-3">warning</i>
                            <h6>Alertas</h6>
                            </div>
                            <span>3</span>
                        </div>
